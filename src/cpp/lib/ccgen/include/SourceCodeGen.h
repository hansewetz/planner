...
class SourceCodeGen:public CodeGen{
public:
  // ctors,assign,dtor
  SourceCodeGen(std::ostream&os);
  SourceCodeGen(SourceCodeGen const&)=delete;
  SourceCodeGen(SourceCodeGen&&)=delete;
  SourceCodeGen&operator=(SourceCodeGen const&)=delete;
  SourceCodeGen&operator=(SourceCodeGen&&)=delete;
  virtual~SourceCodeGen()=default;
protected:
